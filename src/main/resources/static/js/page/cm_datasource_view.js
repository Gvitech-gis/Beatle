$(document).ready(function () {
    ...
    */
    ...
    $("#table_list_2").jqGrid({
        ...
        rowNum: 10,
        rowList: [10, 20, 30],
        colNames: ["id", "链接方式", "名称", "地址", "数据库", "端口","描述"],
...
function editdata(id) {
    $("#frameView").attr("src", "../cm_datasource/edit_view.do?id=" + id);
    $('#addmodal').modal({
        keyboard: true
    });
}
 ...
 */
function fnAdd() {
    $("#frameView").attr("src", "../cm_datasource/add_view.do");
    $('#addmodal').modal({
        keyboard: true
    });
}
    ...
    layui.use('layer', function () { //独立版的layer无需执行这一句
        ...
        layer.open({
            ...
            , yes: function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "../cm_datasource/updateroles.do",
...
function fnCraeteSql(){
	$.ajax({
        type: "GET",
        url: "../cm_datasource/createSql.do",
        //data: { id: id },
        dataType: "json",
        success: function (data) {
        	console.log(data);
